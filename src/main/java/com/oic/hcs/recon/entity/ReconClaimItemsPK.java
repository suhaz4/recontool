 ...
 */
@Embeddable
public class ReconClaimItemsPK implements Serializable {
    ...
    public ReconClaimItemsPK() {
    }

    public ReconClaimItemsPK(BigInteger cclaimId, BigInteger cclaimItem) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReconClaimItemsPK)) {
            return false;
        }
        ReconClaimItemsPK other = (ReconClaimItemsPK) object;
    ...
    public String toString() {
        return "entity.ReconClaimItemsPK[ cclaimId=" + cclaimId + ", cclaimItem=" + cclaimItem + " ]";
    }
